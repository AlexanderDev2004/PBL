...
<body class="bg-[#EBEEF5] ">
    ...
    <div class="flex w-full mx-auto">
        <div class="w-64 h-screen bg-[#132145] text-white flex flex-col items-center py-6 absolute top-0">
            ...
            <nav class="w-64 flex flex-col">
                <a href="dosen.php" target="_blank" class="flex items-center gap-4 px-6 py-3 mb-2 bg-[#132145] rounded-lg text-white rounded-lg text-sm font-bold hover:bg-yellow-600 bg-[#F99D1C]">
                ...
                <a href="formDosen.php" target="_blank" class="flex items-center gap-4 px-6 py-3 mb-2 bg-[#132145] rounded-lg text-white rounded-lg text-sm font-bold hover:bg-yellow-600">
                ...
                <a href="#" target="_blank" class="flex items-center gap-4 px-6 py-3 mb-2 bg-[#132145] rounded-lg text-white rounded-lg text-sm font-bold hover:bg-yellow-600">
    ...
    <!-- Graph -->
    <div class="mx-auto rounded-md shadow-md p-4 flex justify-center items-center">
        <div class="flex-col justify-center items-center rounded-lg max-w-screen-xl bg-white mb-14">
            <canvas id="myChart" class="mx-auto mb-14 h-[800px] mb-6 flex rounded"></canvas>
        </div>
    </div>    
    ...
    <div id="Form" class="flex justify-center pt-8">
        <p class="font-bold text-3xl flex text-center items-center text-[#132145] ml-8">Form</p>
    </div>
    ...
    <!-- Javascript Untuk Menyembunyikan Konten tidak aktif -->
    <script>
